...
if __name__ == "__main__":
    ...
    saved_ds_dir = "/exp/hf_ds/processed_common_11_hk"
    ...
    if not os.path.exists(saved_ds_dir+"/train"):
        ...
        ds_train_vect = load_from_disk(saved_ds_dir+"/train")
    ...
    output_dir="/exp/whisper_yue/finetune-whisper-canto/model_out_trpro"
